    ...
    public class OnboardingController : Controller
    {
        ...
        public ActionResult SignUp([Bind(Include="ID,Name,AdminConsented")] Tenant tenant)
        {
            ...
            string authorizationRequest = String.Format(
                "https://login.partner.microsoftonline.cn/common/oauth2/authorize?response_type=code&client_id={0}&resource={1}&redirect_uri={2}&state={3}",
                 Uri.EscapeDataString(ConfigurationManager.AppSettings["ida:ClientID"]),
                 Uri.EscapeDataString("https://microsoftgraph.chinacloudapi.cn"),
        ...
        public async Task<ActionResult> ProcessCode(string code, string error, string error_description, string resource, string state)
        {
            ...
            else
            {
                ...
                AuthenticationContext authContext = new AuthenticationContext("https://login.partner.microsoftonline.cn/common/");
